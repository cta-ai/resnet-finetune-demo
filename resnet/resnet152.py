...
# https://github.com/flyyufelix/cnn_finetune/blob/master/resnet_152.py and:
...
if __name__ == '__main__':
    ...
    # OpenCV dependency removed by using skimage
    # im = cv2.resize(cv2.imread('cat.jpg'), (224, 224)).astype(np.float32)
    im = skimage.io.imread('cat.jpg')
    im = im[:, :, ::-1]
    im = skimage.transform.resize(im, (224, 224)).astype(np.float32)
    im = im * 255
